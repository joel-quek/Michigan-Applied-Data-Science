...
# -------------------------------------------------------------------------------------------------------
outerjoin = pd.merge(ScimEn, energy, how="outer", left_on="Country", right_on= "Country")
outerjoin2 = pd.merge(outerjoin, gdp, how="outer", left_on = "Country", right_on = "Country").set_index('Country')

print(len(outerjoin2)-len(join2))
...
def answer_four():
    ...
    data_info['avgGDP'] = data_info[['2006', '2007', '2008', '2009', '2010', '2011', '2012', '2013', '2014', '2015']].mean(axis=1)
    data_info.sort_values(['avgGDP'], ascending=False, inplace=True)
    # gdp6 = data_info.index[5]
    diff = data_info.iloc[5]['2015'] - data_info.iloc[5]['2006']
    return diff 
